...
internal class EmojiTemplates
{
    ...
    public static DiscordEmoji GetPillOff(DiscordClient client, Bot bot) => DiscordEmoji.FromGuildEmote(client, bot.status.LoadedConfig.Emojis.PillOffId);
    public static DiscordEmoji GetPillOn(DiscordClient client, Bot bot) => DiscordEmoji.FromGuildEmote(client, bot.status.LoadedConfig.Emojis.PillOnId);
