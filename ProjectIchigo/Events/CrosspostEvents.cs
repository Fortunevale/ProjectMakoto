    ...
    internal async Task MessageCreated(DiscordClient sender, MessageCreateEventArgs e)
    {
        Task.Run(async () =>
        {
            ...
            if (e.Channel.Type == ChannelType.News)
            {
                ...
                _bot._guilds.List[e.Guild.Id].CrosspostSettings.CrosspostTasks.Add(new CrosspostMessage
                {
                ...
                {
                    if (_bot._guilds.List[e.Guild.Id].CrosspostSettings.CrosspostTasks.Any(x => x.MessageId == MessageId))
                    {
                        var obj = _bot._guilds.List[e.Guild.Id].CrosspostSettings.CrosspostTasks.First(x => x.MessageId == MessageId);
                        _bot._guilds.List[e.Guild.Id].CrosspostSettings.CrosspostTasks.Remove(obj);
                    }
