...
internal static class Extensions
{
    ...
    internal static int GetRoleHighestPosition(this DiscordMember member) => (member.IsOwner ? 9999 : (!member.Roles.Any() ? 0 : member.Roles.OrderByDescending(x => x.Position).First().Position));
}
