...
internal class ModerationAppCommands : ApplicationCommandsModule
{
    ...
    [SlashCommand("guild-purge", "Scans all channels and deletes the specified user's messages.", (long)(Permissions.ManageMessages | Permissions.ManageChannels))]
    ...
    [SlashCommand("clearbackup", "Clears the stored roles and nickname of a user.", (long)Permissions.ManageRoles)]
    ...
    [SlashCommand("timeout", "Sets the specified user into a timeout.", (long)Permissions.ModerateMembers)]
    ...
    [SlashCommand("remove-timeout", "Removes a timeout from the specified user.", (long)Permissions.ModerateMembers)]
