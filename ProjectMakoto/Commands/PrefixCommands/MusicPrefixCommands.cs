...
public class MusicPrefixCommands : BaseCommandModule
{
    ...
    public class MusicCommands : BaseCommandModule
    {
        ...
        public async Task Help(CommandContext ctx)
            => PrefixCommandUtil.SendGroupHelp(_bot, ctx, "music").Add(_bot.watcher, ctx);
        ...
        public async Task Disconnect(CommandContext ctx) 
            => new Commands.Music.DisconnectCommand().ExecuteCommand(ctx, _bot).Add(_bot.watcher, ctx);
        ...
        public async Task Skip(CommandContext ctx) 
            => new Commands.Music.SkipCommand().ExecuteCommand(ctx, _bot).Add(_bot.watcher, ctx);
        ...
        public async Task ClearQueue(CommandContext ctx) 
            => new Commands.Music.ClearQueueCommand().ExecuteCommand(ctx, _bot).Add(_bot.watcher, ctx);
    ...
    public class Playlists : BaseCommandModule
    {
        ...
        [GroupCommand, Command("help"), Description("Sends a list of available sub-commands")]
        public async Task Help(CommandContext ctx)
            => PrefixCommandUtil.SendGroupHelp(_bot, ctx, "playlists").Add(_bot.watcher, ctx);
        ...
        public async Task AddToQueue(CommandContext ctx, [Description("Playlist Id")] string id) 
            => SendUnavailable(ctx).Add(_bot.watcher, ctx);
