...
internal sealed class SoftBanCommand : BaseCommand
{
    ...
    public override Task ExecuteCommand(SharedCommandContext ctx, Dictionary<string, object> arguments)
    {
        return Task.Run(async () =>
        {
            ...
            var CommandKey = this.t.Commands.Moderation.Softban;
            ...
            try
            {
                ...
                await ctx.Guild.UnbanMemberAsync(victim, this.GetGuildString(CommandKey.AuditLog, new TVar("Reason", newReason)));
