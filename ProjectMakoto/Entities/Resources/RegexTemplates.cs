...
internal static class RegexTemplates
{
    ...
    public static readonly Regex SpotifyUrl = new(@"https?://(open\.spotify\.com|spotify\.link)(/track)?/([^ ?&])+(\?si\=[^ ?&]*)?", RegexOptions.IgnoreCase | RegexOptions.Compiled);
