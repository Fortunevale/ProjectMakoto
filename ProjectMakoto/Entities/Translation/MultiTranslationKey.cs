...
public sealed class MultiTranslationKey : IDictionary<string, string[]>
{
    ...
    public string[] Get(User user)
    {
        ...
        return !this.t.TryGetValue(Locale, out var value) ? (new string[] { "Missing Translation. Please report to the developer." }) : value;
    }
