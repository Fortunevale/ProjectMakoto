...
internal class UrlSubmissions
{
    ...
    public bool AcceptedTOS { get => _AcceptedTOS; set { _AcceptedTOS = value; _ = Bot._databaseClient.SyncDatabase(); } }


    private DateTime _LastTime { get; set; } = DateTime.MinValue;
    public DateTime LastTime { get => _LastTime; set { _LastTime = value; _ = Bot._databaseClient.SyncDatabase(); } }
