...
internal class AfkStatusMessageCache
{
    ...
    public ulong GuildId { get => _GuildId; set { _GuildId = value; _ = Bot._databaseHelper.SyncDatabase(); } }



    private ulong _AuthorId { get; set; } = 0;
    public ulong AuthorId { get => _AuthorId; set { _AuthorId = value; _ = Bot._databaseHelper.SyncDatabase(); } }
}
